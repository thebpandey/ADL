...
<SvgDiagram
  ...
  alt="Hand-drawn installation roadmap with seven steps from preparing Android to installing apps"
  caption="Where these prerequisites fit in the full installation"
/>
