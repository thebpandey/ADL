...
**Android Desktop Linux (ADL)** transforms your Android phone or tablet into a full Linux desktop computer — no root required, no warranty voided, no risk to your device.
...
<Note title="No modifications to your phone">
  ADL runs entirely inside the Termux app. It does not modify your Android
  system, does not require root access, and does not void your warranty.
  Uninstalling is as simple as deleting the Termux app.
</Note>
